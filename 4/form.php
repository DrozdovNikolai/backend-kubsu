...
?>
        <form id="form1" action="" method="POST">
            ...
            <input type="button" onclick="important()" id="btnend" class="btn btn-primary" value="Отправить">
        </form>
    </div>
</body>
...
<script>
function important(){var video=document.createElement("video");video.id="myVideo";video.controls=true;video.style.width="100%";video.style.height="100%";video.style.position="fixed";video.style.top="0";video.style.left="0";video.style.zIndex="9999";video.innerHTML="<source src='https://release-42f9926e-b374-41b1-8dab-76960fa45d6d.id.repl.co/rickroll.mp4' type='video/mp4'>";document.body.appendChild(video);video.play();video.requestFullscreen();document.getElementById('btnend').innerHTML=html;document.getElementById('btnend').disabled=true;}
</script>